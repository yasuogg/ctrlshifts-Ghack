...
<div className="flex flex-col  shadow-2xl px-12 py-12   rounded-lg bg-white">
...
<h1 className="pt-6">Don't have an account? <Link href='signup' className="text-white" >Sign up</Link></h1>
