export default function Looking() {
  return (
    <div className="flex flex-col justify-center items-center mt-16 w-full ">
      <h1 className=" pb-6 text-3xl lg:w-[30%] md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-500 to-pink-500  text-transparent bg-clip-text text-center">
        Everything your team is looking for
      </h1>

      <p className="pt-6 text-center  ">
        <span className="font-bold">
          CollaboraPro’s exceptional flexibility can handle any type of work.
        </span>{" "}
      ...
      <div>
        <div className="flex flex-col lg:flex-row justify-center items-center lg:space-x-12 space-y-6   text-white ">
          <div className=" flex flex-col rounded-lg justify-center items-center text-center py-[8%] lg:py-[6%] md:w-[50%] lg:w-[20%] bg-gradient-to-r from-sky-500 to-indigo-500">
            ...
            <li className="text-1/2">
              The ability to quickly set up and customize workflows for just
              about anything.
            </li>
            <li>
              Optimize resource utilization with AI task suggestions.Data-driven
              decision-making with AI-generated reports.
            </li>
          </div>
          <div className=" flex flex-col rounded-lg justify-center items-center pl-6  py-[8%] lg:py-[6%] md:w-[50%] lg:w-[20%] bg-gradient-to-r from-sky-500 to-indigo-500">
            ...
            <li>
              Organized project execution with task categorization and Gantt
              diagrams.
            </li>
