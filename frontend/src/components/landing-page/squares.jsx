...
export default  function Squares (){
    return(
        ...
        <RiTeamFill className="text-6xl" />
            ...
            <p className="text-xl">Manage projects, organize tasks, and build team spirit—all in one place. for what</p>
        </div>
        ...
        <FaUserCheck className="text-6xl" />
            ...
            <p className="text-xl">Every single part of your task can be managed, tracked, and shared with teammates.</p>
        </div>
