    ...
    <nav>
      <div className="flex justify-evenly items-center pt-8">
        ...
        <div>
          <div className="hidden md:block">
            <ul className="flex space-x-3 lg:space-x-7 font-  justify-center items-center">
              ...
              <li>
                <Dropdown options={Solutions} />
              </li>
              <li>
                <Dropdown options={Learn} />
              </li>
              <li>
                <Link href="#" className="hover:text-[#C637A0] duration-300">
                  Pricing
                </Link>
              </li>
              <li>
        ...
        <div className="flex space-x-4 text-white">
          <button className="bg-[#C637A0] py-2 px-3 rounded-lg	 ">
            Sign Up
          </button>
          <button className="bg-[#ACACAC] hidden md:block py-2 px-3 rounded-lg	">
            Log in
          </button>
        </div>
      ...
      >
        <div className=" fixed  bg-white text-black z-16 w-screen h-screen top-0 left-0  sm-hidden    ">
          <div className="flex flex-row items-center justify-evenly w-full pb-8 pt-2  ">
            <h1 className="flex justify-end font-bold  text-4xl pt-6 lg:text-4xl">
              CollaboraPro
            </h1>
            <button
              className=" flex text-[30px] text-black pt-6 "
              onClick={toggleMobileMenu}
            >
              <IoMdClose />
            </button>
          ...
          <div className="flex flex-col   text-[25px]   ">
            ...
            <div className=" pt-8 flex flex-col justify-center  space-y-4 text-white">
              <button className="bg-[#C637A0] py-3 px-24 rounded-lg">
                Sign Up
              </button>
              <button className="bg-[#ACACAC] py-3 px-24 rounded-lg">
                Log in
              </button>
            </div>
          </div>
